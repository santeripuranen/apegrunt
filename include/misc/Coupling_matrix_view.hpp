/** @file Coupling_matrix_view.hpp
	...
	$Id: $
*/
#ifndef APEGRUNT_COUPLING_MATRIX_VIEW_HPP
#define APEGRUNT_COUPLING_MATRIX_VIEW_HPP
...
{
#pragma message("FIX ME: convert() implementation should use the AccessOrder::ptr_increment() function ..or should it? ")
...
{
#pragma message("FIX ME: copy() implementation should use the AccessOrder::ptr_increment() function ..or should it?")
	if( transpose )
	{
		for( std::size_t row=0; row < AccessOrder::N; ++row )
		{
...
#endif // APEGRUNT_COUPLING_MATRIX_VIEW_HPP
